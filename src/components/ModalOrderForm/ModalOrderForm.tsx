...
export const ModalOrderForm = () => {
    ...
    return (
        <>
            <Button variant="outlined" onClick={handleOpen}>Place an order</Button>
            <Modal
                open={open}
                onClose={handleClose}
                ...
                <Box sx={style}>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <Controller
                            ...
                            defaultValue=""
                            render={({field}) =>
                                <TextField {...field} label='Email' type={"email"} fullWidth required variant="filled"/>}
                        />
                        <Controller
                            name='address'
                            control={control}
                        ...
                        />
                        <Button type="submit" fullWidth variant="contained" style={{marginTop: '30px'}}>Confirm</Button>
                    </form>
                </Box>
            </Modal>
        </>
